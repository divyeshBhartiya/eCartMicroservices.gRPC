...
namespace Product.gRPC.Services
{
    public class ProductService: ProductProtoService.ProductProtoServiceBase
    {
        ...
        public override async Task GetAllProducts(GetAllProductsRequest request, IServerStreamWriter<ProductModel> responseStream,
        ...
        public override async Task<InsertBulkProductResponse> InsertBulkProduct(IAsyncStreamReader<ProductModel> requestStream, ServerCallContext context)
        {
            ...
            {
                var product = _mapper.Map<Products>(requestStream.Current);
                _productDbContext.Product.Add(product);
            }
